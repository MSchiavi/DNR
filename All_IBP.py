...
for i in range(len(External)):
	for j in range(len(Internal)):
		...
		#print(_IBP.Get_IBP(External[i],Internal[j])[1][2].get_index())
		#print(_IBP.Get_IBP(External[i],Internal[j])[1][2].get_op())

		#print(_IBP.Get_IBP(External[i],Internal[j])[1][3].get_index())
		#print(_IBP.Get_IBP(External[i],Internal[j])[1][3].get_op())
				
		#print(_IBP.Get_IBP(External[i],Internal[j])[1][4].get_index())
		#print(_IBP.Get_IBP(External[i],Internal[j])[1][4].get_op())
...
for i in range(len(Internal)):
	for j in range(len(Internal)):
		...
		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][2].get_index())
		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][2].get_op())

		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][3].get_index())
		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][3].get_op())
				
		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][4].get_index())
		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][4].get_op())
		


		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][7].get_index())
		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][7].get_op())

		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][8].get_index())
		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][8].get_op())
				
		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][9].get_index())
		#print(_IBP.Get_IBP(Internal[i],Internal[j])[1][9].get_op())
